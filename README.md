...
Read docs/TOOLCHAIN.md for more information on building the toolchain.
...
Now prepare a `.env` file or simply update PATH and MAKEFLAGS yourself and execute `fakeroot ./puppyos.sh build` to build the system.
