...
build "pkgs/libs/net/libssh2.sh"
...
build "pkgs/utils/linux/lsof.sh"
build "pkgs/utils/monitoring/lm-sensors.sh"
build "pkgs/utils/monitoring/btop.sh"
build "pkgs/utils/monitoring/htop.sh"
...
build "pkgs/daemons/ntp.sh"
build "pkgs/daemons/openssh.sh"
